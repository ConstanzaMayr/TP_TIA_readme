...
Instalacion y uso:
	Se instala desde la pagina web
...
Colaboracion:
	Para contribuir:
		...
		2-Crear una rama(Gitcheckout-bfeature/nueva-funcion)
		3-Realizar cambios
		4-Enviar un pull request
		Para reportar errores: usar la seccion issues

Licencia: Este proyecto esta bajo la licencia MIT
	Importante: Los usuarios son responsables del contenido que suben.No se permite la distribucion ilegal de material con derechos de autor.

Autores: Constanza Mayr, Jazmin Paz, Brisa Jerez, Benjamin Juarez, Feipe Funes Carcano
