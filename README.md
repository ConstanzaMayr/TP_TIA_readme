...
# Features
- Subscription: A monthly payment that gives the user unlimited access to books from the platform and other users.

- Fast Growth: Because users can upload and sell their own books, the library is always growing.

- Marketplace: Our platform creates a market where the community can buy and sell books.
...
## Authors
**Constanza Mayr, Jazmin Paz, Brisa Jerez, Benjamin Juarez, Felipe Funes Carcano.**
...
**Para reportar errores: Por favor, usar la sección de Issues.**

# Licencia
Este proyecto está bajo la Licencia MIT.

**Importante: Los usuarios son responsables del contenido que suben. No se permite la distribución ilegal de material con derechos de autor.**
